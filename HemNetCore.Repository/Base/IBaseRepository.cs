...
namespace HemNetCore.Repository.Base
{
    ...
    public interface IBaseRepository<TEntity> where TEntity : class
    {
        ...
        /// <param name="strOrderByFileds"></param>
        /// <returns></returns>
        Task<PagedModel<TResult>> QueryTabsPage<T, T2, TResult>(Expression<Func<T, T2, object[]>> joinExpression, Expression<Func<T, T2, TResult>> selectExpression, Expression<Func<T,T2, bool>> whereExpression = null, int intPageIndex = 1, int intPageSize = 20, string strOrderByFileds = null);

        Task<PagedModel<TResult>> QueryTabsPage<T, T2, T3, TResult>(Expression<Func<T, T2, T3, object[]>> joinExpression, Expression<Func<T, T2, T3, TResult>> selectExpression, Expression<Func<T, T2, T3, bool>> whereExpression = null, int intPageIndex = 1, int intPageSize = 20, string strOrderByFileds = null);
